...
const policy = () => {
  return (
    <>
          ...
          <div className="row">
            <div className="col-12">
              <div className="section--wrap">
                <div className="section__title">Private Policy</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="policy" style={{marginTop: "70px"}}>
        <div className="container">
          <div className="row">
            <div className="col-12">
            ...
            <div className="col-12">
              <ol>
                <li>Determination of personal information of users
                  <ol>
                ...
                <li>Reasons for collecting and processing user personal information
                  <ol>
